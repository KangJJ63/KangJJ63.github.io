...
- ### Git bash 설치
  ...
  - [git bash 다운로드 바로가기](https://git-scm.com/downloads)
    ...
    <br>
      ...
      ![git bash 다운로드 사이트](/assets/posts/blog/github/01/01.png)
...
-  ### Ruby 설치
   ...
   - [Ruby 다운로드 바로가기](https://rubyinstaller.org/downloads/)
       ...
       ![Ruby 다운로드 사이트](/assets/posts/blog/github/01/02.png)
...
- ### Node.js 설치
  ...
  - [node.js 다운로드 바로가기](https://nodejs.org/en/download)
    ...
    <br>
      ...
      ![node.js 다운로드 사이트](/assets/posts/blog/github/01/03.png)
...
- ### 버전 확인
    ...
    git -v
    ```
    ![git 버전 확인](/assets/posts/blog/github/01/04.png){: width="100%" height="589" }
  ...
  gem -v
  ```
  ![Ruby 버전 확인](/assets/posts/blog/github/01/05.png)
  ...
  npm -v
  ```
  ![node.js 버전 확인](/assets/posts/blog/github/01/06.png)
...
- ### Github이란?
  ...
  ![리포지토리 생성하기](/assets/posts/blog/github/01/07.png)

  <br>
  <br>

  리포지토리 이름을 설정하면 되는데, **`자신의 아이디.github.io`** 로 설정한다. 해당 형식을 지키지 않으면, 나중에 Github Pages에서 해당 리포지토리를 사용못한다고 한다.. **이건 반드시 지키자!** 나머지 설정은 취향껏하면 될 것 같다.

  ![리포지토리 생성하기](/assets/posts/blog/github/01/08.png)
  ...
  ![리포지토리 생성하기](/assets/posts/blog/github/01/09.png)
  ...
  ![리포지토리 복제하기](/assets/posts/blog/github/01/10.png)
...
- ### Jekyll 이란?
  ...
  bundler -v
  ```
  ![jekyll 버전 확인](/assets/posts/blog/github/01/11.png)
...
![jekyll 로컬 서버 생성](/assets/posts/blog/github/01/12.png)
...
![jekyll 로컬 서버 생성](/assets/posts/blog/github/01/14.png)
