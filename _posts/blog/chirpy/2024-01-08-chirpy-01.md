...
- ### 버전 확인
    ...
    git -v
    ```
    ![git 버전 확인](assets/img/blog/github/01/04.png){: width="100%" height="589" }
...
- ### Jekyll 이란?
  ...
  bundler -v
  ```
  ![jekyll 버전 확인](assets/img/blog/github/01/11.png)
...
![jekyll 로컬 서버 생성](assets/img/blog/github/01/12.png)
...
![jekyll 로컬 서버 생성](assets/img/blog/github/01/13.png)
<br>
<br>
...
![jekyll 로컬 서버 생성](assets/img/blog/github/01/14.png)
